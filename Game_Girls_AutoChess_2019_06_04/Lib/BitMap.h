...
namespace JEngine
{
	...
	*/
	...
	public:
		...
		void			Draw(int x, int y, int LastX, int LastY, int MemX, int MemY);
		void			Draw(int x, int y, int LastX, int LastY);
		void			Draw(JEngine::POINT pt);
		void			Draw(JEngine::POINT pt, JEngine::POINT Lastpt, JEngine::POINT Mempt);
		void			Draw(JEngine::POINT pt, JEngine::POINT Lastpt);
